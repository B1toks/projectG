    ...
    <div className="p-6 md:p-10 w-full max-w-screen-2xl mx-auto">
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        ...
        <Select onValueChange={setSubjectFilter}>
          ...
          <SelectContent className='dark:border-zinc-700 bg-white dark:bg-zinc-800'>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {filtered.map((task) => (
          <div
            key={task.id}
            className={cn(
              'rounded-lg border dark:border-zinc-700 p-4 bg-white dark:bg-zinc-800 relative transition-all',
              'hover:shadow-md'
            )}
          >
            {activeTab === 'done' && (
